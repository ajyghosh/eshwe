...
const description = "Explore sarees at eshwe Saree Studio: mul cotton, Kanchi cotton, Sungudi cotton, soft silk and tissue silk. Discover saree styles, culture and everyday favourites.";
...
export const homeMetadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://eshwe.com/",
    type: "website",
    images: [{ url: "/hero.webp", width: 1536, height: 1024, alt: "Saree styles at eshwe Saree Studio" }]
  },
